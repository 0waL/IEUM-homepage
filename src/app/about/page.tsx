      ...
      <section className="py-24 bg-navy-950">
        <div className="max-w-6xl mx-auto px-6 sm:px-10 lg:px-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              { icon: Code2, title: "실전 경험", desc: "교과서 밖에서, 실제로 사용되는 서비스를 직접 만들며 배웁니다.", gradient: "from-blue-500 to-cyan-500", delay: 0 },
              { icon: Users, title: "팀워크", desc: "혼자가 아닌 팀으로, 서로의 강점을 모아 더 큰 것을 만듭니다.", gradient: "from-green-500 to-emerald-500", delay: 80 },
              { icon: Trophy, title: "성장", desc: "스터디, 해커톤, 공모전을 통해 지속적으로 실력을 키워갑니다.", gradient: "from-amber-500 to-yellow-500", delay: 160 },
              { icon: Heart, title: "기여", desc: "우리가 만드는 서비스로 학교 구성원의 삶을 더 편리하게 만듭니다.", gradient: "from-rose-500 to-pink-500", delay: 0 },
              { icon: BookOpen, title: "지식 공유", desc: "배운 것을 나누고, 함께 공부하며 집단 지성을 키웁니다.", gradient: "from-primary-500 to-violet-500", delay: 80 },
              { icon: Zap, title: "도전", desc: "새로운 기술과 아이디어에 두려워하지 않고 도전합니다.", gradient: "from-orange-500 to-red-500", delay: 160 },
            ].map((item) => (
              <FadeIn key={item.title} delay={item.delay}>
                <div className="bg-navy-900 border border-white/8 rounded-2xl p-7 hover:border-primary-600/30 transition-all duration-300 hover:-translate-y-0.5 h-full">
                  <div className={`w-11 h-11 bg-gradient-to-br ${item.gradient} rounded-xl flex items-center justify-center mb-4 shadow-lg`}>
